...
public class Integrator extends AbstractComponent {
	private String rmipURI;
	private String csipURI;
	private String avmipURI;
	
	/**
	 * Port connected to the request generator component to manage its execution
	 * (starting and stopping the request generation).
	 */
	private RequestGeneratorManagementOutboundPort rmop;
	...
	Integrator(String csipURI, String avmipURI, String rmipURI) throws Exception {
		super(1, 0);
	...
	public void start() throws ComponentStartException {
		...
		try {
			this.doPortConnection(this.csop.getPortURI(), this.csipURI,
					ComputerServicesConnector.class.getCanonicalName());
			this.doPortConnection(this.rmop.getPortURI(), rmipURI,
					RequestGeneratorManagementConnector.class.getCanonicalName());
			this.doPortConnection(this.avmop.getPortURI(), avmipURI,
