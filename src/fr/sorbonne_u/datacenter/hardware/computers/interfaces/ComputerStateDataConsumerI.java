 ...
 * side methods used to receive state data pushed by a computer, both static and
 * dynamic.
 *
 * <p>
 ...
 * will consume as clients state data pushed by a computer. They are used by
 * <code>ComputerStaticStateOutboundPort</code> and
 * <code>ComputerDynamicStateOutboundPort</code> to pass these data upon
 * reception from the processor component.
 * 
 * As a client component may receive data from several different computers, it
...
public interface ComputerStateDataConsumerI {
	 ...
	 */
	void acceptComputerStaticData(String computerURI, ComputerStaticStateI staticState) throws Exception;
	 ...
	 */
	void acceptComputerDynamicData(String computerURI, ComputerDynamicStateI currentDynamicState)
			throws Exception;
}
